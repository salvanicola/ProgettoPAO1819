...
QT_MOC_LITERAL(6, 60, 11), // "sendmessage"
QT_MOC_LITERAL(7, 72, 23), // "ContainerList<QString>*"
QT_MOC_LITERAL(8, 96, 14) // "receivemessage"

    },
    "Modeluozapp\0newmessage\0\0messagereceive\0"
    "message*\0messagesend\0sendmessage\0"
    "ContainerList<QString>*\0receivemessage"
};
...
static const uint qt_meta_data_Modeluozapp[] = {
 ...
 // slots: parameters
    0x80000000 | 4, 0x80000000 | 7, QMetaType::QString, QMetaType::QString,    2,    2,    2,
    0x80000000 | 4, 0x80000000 | 7, QMetaType::QString,    2,    2,
    0x80000000 | 4, 0x80000000 | 7,    2,
    QMetaType::Void, 0x80000000 | 4,    2,
...
void Modeluozapp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { message* _r = _t->sendmessage((*reinterpret_cast< ContainerList<QString>*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 4: { message* _r = _t->sendmessage((*reinterpret_cast< ContainerList<QString>*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 5: { message* _r = _t->sendmessage((*reinterpret_cast< ContainerList<QString>*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 6: _t->receivemessage((*reinterpret_cast< message*(*)>(_a[1]))); break;
        default: ;
        }
