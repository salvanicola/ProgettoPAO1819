...
QT_MOC_LITERAL(7, 72, 14) // "receivemessage"
...
void Modeluozapp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { message* _r = _t->sendmessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 4: { message* _r = _t->sendmessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 5: { message* _r = _t->sendmessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
        case 6: { message* _r = _t->sendmessage((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< message**>(_a[0]) = std::move(_r); }  break;
