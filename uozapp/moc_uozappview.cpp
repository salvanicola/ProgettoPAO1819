...
#include "Controller-View/uozappview.h"
...
QT_MOC_LITERAL(3, 23, 9) // "pressSend"

    },
    "UozAppview\0newMessage\0\0pressSend"
};
...
void UozAppview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pressSend(); break;
        default: ;
        }
    }
}

const QMetaObject UozAppview::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UozAppview.data,
      qt_meta_data_UozAppview,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UozAppview::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UozAppview.stringdata0))
        return static_cast<void*>(const_cast< UozAppview*>(this));
